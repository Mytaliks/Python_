...
# Общая сложность O(n)
def autho_1(users, user_name, user_password):
...
# общая сложность O(1)
def autho_2(users, user_name, user_password):
...
my_users = {'user1': {'password': '18881', 'activation': False},
            'user2': {'password': '12312', 'activation': True},
            'user3': {'password': '30789', 'activation': False},
            'user4': {'password': '95581', 'activation': True}
            }

print(autho_1(my_users, 'user6', '1111'))
print(autho_2(my_users, 'user6', '1111'))
print(autho_2(my_users, 'user2', '12312'))
print(autho_2(my_users, 'user1', '18881'))